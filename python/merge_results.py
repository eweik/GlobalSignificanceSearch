...
def main(args):
    ...
    methods = ["naive", "linear", "copula", "poisson_event", "exclusive_categories"]
    ...
    for trig in triggers:
        ...
        colors = {"naive": "red", "linear": "blue", "copula": "orange", "poisson_event": "green", "exclusive_categories": "purple"}
